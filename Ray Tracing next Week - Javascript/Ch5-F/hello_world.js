...
class HelloWorld{
    ...
    perlin_spheres(){
        ...
        var ground_material = new Lamberiant({albedo:new Vec3(0, 1, 0),tex:this.perlinTexture});
   ...
   async  scanline(render,progress){
    ...
    cam.focus_dist    = 10.0;
       ...
       this.camera_ctrl.add( this.perlinTexture,'scale', 0, 100,1).name("Perlin Noise").onChange(update); 
