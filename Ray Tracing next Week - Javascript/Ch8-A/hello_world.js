class HelloWorld {
  ...
  cornell_box() {
    ...
    this.objects.push(Quad.box(new Point3(130, 0, 65),new Point3(295, 165, 230),white))
    this.objects.push(Quad.box(new Point3(265, 0, 295),new Point3(430, 330, 160),white))
