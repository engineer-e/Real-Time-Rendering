class Camera {
  ...
  ray_color(r, depth, world) {
    ...
    if (hitResult) {
      ...
      var color_from_emission = rec.material.emitted(rec.u, rec.v, rec.p);

      // var didScatter = rec.material.scatter(
      //   r,
      //   rec,
      //   (attenuation) => {
      ...
      var color_from_scatter = Vec3.mul({
        u: attenuation,
        v: this.ray_color(scattered, depth - 1, world),
      });
