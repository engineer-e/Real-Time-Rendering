...
import concurrent.futures # NEW: For multi-threading
    ...
    def render(self, world):
        ...
        def render_row(j_row):
            ...
            for i in range(self.image_width):
                ...
                row_pixels.append(f"{int(256*r)} {int(256*g)} {int(256*b)}")
            return "\n".join(row_pixels)

        # CHANGED: file-based PPM output with multi-threading
        with open(self.output_file, "w") as f:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                results = list(tqdm(executor.map(render_row, range(self.image_height)), total=self.image_height,
                                    desc="Rendering", postfix=system_monitor()))
