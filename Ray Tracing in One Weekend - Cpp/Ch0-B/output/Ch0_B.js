...
var ASM_CONSTS = {
  65606: ($0) => { document.getElementById("output").innerHTML += UTF8ToString($0) + "<br>"; }
};

// Imports from the Wasm binary.
var _printMessage = Module['_printMessage'] = makeInvalidEarlyAccess('_printMessage');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['printMessage'] != 'undefined', 'missing Wasm export: printMessage');
  ...
  _printMessage = Module['_printMessage'] = createExportWrapper('printMessage', wasmExports['printMessage'], 1);
  _menu = Module['_menu'] = createExportWrapper('menu', wasmExports['menu'], 1);
