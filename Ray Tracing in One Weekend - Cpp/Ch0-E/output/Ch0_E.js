...
var ASM_CONSTS = {
  68720: () => { FS.mkdir('/data'); FS.mount(IDBFS,{},'/data'); FS.syncfs(true,function(err) { if(err) console.log(err); else console.log("Loaded"); }); },  
 68860: () => { FS.syncfs(false,function(err) { if(err) console.log(err); else console.log("Saved"); }); }
};
