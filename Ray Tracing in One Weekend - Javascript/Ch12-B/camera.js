class Camera{
    ...
    initialize(){
     /**
        ...
        this.viewport_height = 2 * h * this.focal_length;
    ...
    //  this.viewport_v = new Vec3(0, -this.viewport_height, 0);
     ...
     this.viewport_upper_left = Vec3.sub(Vec3.sub(Vec3.sub(this.camera_center,Vec3.mul({t:this.focal_length,v:this.w})),viewport_u_half),viewport_v_half)
